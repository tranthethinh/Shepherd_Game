...
public class SheepController : MonoBehaviour
{
    ...
    private float minGroupDistance = 3f;
    private float maxGroupDistance = 30f;
    ...
    private float actionDuration=5;
    //sound
    ...
    void SetSheepAroundAsFollowers(Vector3 posScare)
    {
        ...
        {
            SheepController sheepController = sheepTransform.GetComponent<SheepController>();
    ...
    Transform GetClosestScare(List<Transform> listScare)
    {
